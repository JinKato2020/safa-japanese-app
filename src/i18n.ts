...
const en = {
  ...
  audioPlaying: 'Playing… (tap to pause)',
...
const ja: Strings = {
  ...
  audioPlay: '音声を再生', audioPlaying: '再生中…（タップで停止）',
  ...
  theme: 'テーマ', themeAuto: '自動', themeDefault: '標準', themeSakura: '桜水彩', themeSora: '空水彩', themeMidori: '新緑水彩', themeFuji: '藤水彩', themeAkane: '茜水彩', themeDark: 'ダーク',
  font: 'フォント', fontSystem: '標準', fontMaru: '丸ゴシック', fontMincho: '明朝', fontKyokasho: '教科書体',
  listDesign: 'リストのデザイン', listB: '和モダン（明朝）', listC: 'やわらか（教科書体）',
